  ...
  return (
    <>
      ...
      <div className="text-center mb-16">
        <h1 className={`${title()} text-5xl font-bold text-gray-900 mb-4`}>About PiShop</h1>
        <p className={`${subtitle()} text-xl text-gray-600 max-w-2xl mx-auto`}>
          Your trusted e-commerce partner in Budapest, connecting quality products with customers
          across Hungary and Europe.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose PiShop?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          />
          <FeatureCard icon="🤝" title="Local Support" description="Dedicated Hungarian team" />
        </div>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-8">
          Join our network of successful sellers and expand your reach across Hungary and Europe.
        </p>
        <Link
          href="/contact"
