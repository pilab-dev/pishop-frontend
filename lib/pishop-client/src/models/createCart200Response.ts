 ...
 * 
 * @export
 * @interface CreateCart200Response
 */
export interface CreateCart200Response {
    /**
     * 
     * @type {string}
     * @memberof CreateCart200Response
     */
    cartId?: string;
}

/**
 * Check if a given object implements the CreateCart200Response interface.
 */
export function instanceOfCreateCart200Response(value: object): value is CreateCart200Response {
    return true;
}

export function CreateCart200ResponseFromJSON(json: any): CreateCart200Response {
    return CreateCart200ResponseFromJSONTyped(json, false);
}

export function CreateCart200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCart200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateCart200ResponseToJSON(json: any): CreateCart200Response {
    return CreateCart200ResponseToJSONTyped(json, false);
}

export function CreateCart200ResponseToJSONTyped(value?: CreateCart200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
