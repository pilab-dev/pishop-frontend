...
export interface EntityCreated {
     ...
     * 
     * @type {string}
     * @memberof EntityCreated
     */
    id: string;
}

/**
 * Check if a given object implements the EntityCreated interface.
 */
export function instanceOfEntityCreated(value: object): value is EntityCreated {
    if (!('id' in value) || value['id'] === undefined) return false;
    return true;
}

export function EntityCreatedFromJSON(json: any): EntityCreated {
    return EntityCreatedFromJSONTyped(json, false);
}

export function EntityCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityCreated {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityCreatedToJSON(json: any): EntityCreated {
    return EntityCreatedToJSONTyped(json, false);
}

export function EntityCreatedToJSONTyped(value?: EntityCreated | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
